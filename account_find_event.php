					...
					<form name="Search_Events" id="Search_Events" action="acc_event_result.php" method="post" onsubmit="javascript: return acc_fnd_eve_chk()">
                    	<div class="tab_box_bg_inner">
                        	...
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
                            	<div class="col-md-12"><?=$a[1]?></div>
                                <div class="form-group">
                                	<div class="col-md-12">Search Events :</div>
                                    <div class="col-md-6">
                                    	<input type="text" class="form-control" name="event_name" id="event_name" onBlur="if(this.value==''){this.value='Event Name or Host Name'}" onFocus="if(this.value=='Event Name or Host Name'){this.value=''}" value="Event Name or Host Name" />
                                    </div>
                                     <div class="col-md-4">
                                    <input type="submit" name="Submit_eve" id="Submit_eve" class="search_eve_form_btn" value="" />
                                    </div>
                                </div>
                            </div>
                        </div>
