                ...
                <table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td align="left" valign="top" class="middle_right_bg">
                        ...
                        <tr>
                        <td>
                         <form name=addprod  method=post enctype="multipart/form-data" onsubmit="javascript: return valid();">
                        <input type="hidden" name="FRMCATID">
                                ...
                                <TABLE cellSpacing=2 cellPadding=1 width=500 border=0>
                                  <TBODY>
                                    ...
                                    <? } ?>
                                    <TR> 
                                      <TD class=f-c vAlign=top align=right>&nbsp;&nbsp;<font color="red">*</font>Password</TD>
                                      <TD vAlign=top colSpan=3><input name="name" type="text"  class="solidinput" value="<?php echo $name; ?>" size="30" >					   </TD>
                                    </TR>
                                    <TR> 
                                      <TD colSpan=4>&nbsp;</TD>
                                    </TR>
                                    <TR> 
                                      <TD align=right>&nbsp;</TD>
                                      <TD><INPUT type=submit name="Submit" value="Submit" class="send_form" >						</TD>
                                      <TD align=right>&nbsp;</TD>
                                      <TD>&nbsp;</TD>
                                    </TR>
                                    <TR> 
