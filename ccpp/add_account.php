			...
			if(isset($_REQUEST['mode']))
		{
			switch($_REQUEST['mode'])
			{
				case 'add' :
					...
					set display_order='$display_order',add_date='$add_date',password='$password',temp='$temp',fname='$fname',lname='$lname',email='$email',phone='$phone',payment_method='$payment_method',mstreet_address='$mstreet_address',mapartment='$mapartment',mcity='$mcity',mstate='$mstate',mzip='$mzip',mcountry='$mcountry',mcomments='$mcomments',paypalid='$paypalid',city='$city',state='$state',country='$country',find_us='$find_us',acc_notes='$acc_notes',ran_no='$key'"; 
					hb_get_result($query) or die(mysql_error());
					location("manage_accounts.php?msg=1");
				break;
				
				case 'edit' :
					if(GTG_is_dup_edit('organizer','email',$email,$_REQUEST['id']))
					{
						unset($_REQUEST['Submit']);	
						location("add_account.php?mode=edit&id=".$_REQUEST['id']."&msg=4");	
						return;
					}
					$query = "update organizer set add_date='$add_date',password='$password',fname='$fname',lname='$lname',email='$email',phone='$phone',payment_method='$payment_method',mstreet_address='$mstreet_address',mapartment='$mapartment',mcity='$mcity',mstate='$mstate',mzip='$mzip',mcountry='$mcountry',mcomments='$mcomments',paypalid='$paypalid',city='$city',state='$state',country='$country',find_us='$find_us',acc_notes='$acc_notes',temp='$temp',ran_no='$key'"; 
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td align="left" valign="middle" class="title_wrapper_middle"><? echo ($_GET["id"]>0)?"Edit":"Add"; ?> Account</td>
                          ...
                          <tr>
							...
							?>
                                ...
                                <TR>
                                  <TD><form action="add_account.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();">
                                      ...
                                      <table width="100%" border="0" align="left" cellpadding="3" cellspacing="3" class="solidinput">
                                        ...
                                        <tr>
                                          <td  align="right" class="menu-a"><span class="a-l"><strong>Basic Account  Information :</strong></span></td>
                                          <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td width="71%" class="f-c"><input  name="cpassword" size="30" type="password" id="cpassword" value="<?=$password; ?>" /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td width="29%" align="right" class="f-c"><span style="color:#FF0000;">*</span>State :</td>
                                          <td width="71%" class="f-c"><?php /*?><input  name="state" type="text" size="30" id="state" value="<?=$state; ?>" /><?php */?>
                                        ...
                                        <tr>
                                          <td width="29%" align="right" class="f-c"><span style="color:#FF0000;">*</span>Country :</td>
                                          <td width="71%" class="f-c"><?php /*?><input  name="country" type="text" size="30" id="country" value="<?=$country; ?>" /><?php */?>
									...
									<tr>
                                        ...
                                        <tr>
										  ...
										  <?php /*?><?php
											...
											$oFCKeditor22->Create() ;?><?php */?>
					<textarea name="acc_notes" style="width:100%;height:300PX"> <?=$acc_notes?></textarea> 
					<script type="text/javascript">
					//<![CDATA[

					var editor = CKEDITOR.replace( 'acc_notes' ,{
