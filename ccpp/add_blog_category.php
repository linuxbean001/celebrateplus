			...
			switch($_REQUEST['mode'])
			{
				case 'add' :
					if(GTG_is_dup_add('blog_categories','category_name',$category_name))
					{
						...
						location("add_blog_category.php?mode=add&msg=4");
						return;
					}
					...
					location("manage_blog_categories.php?msg=1");
				break;
				...
				case 'edit' :
					...
					{
						unset($_REQUEST['Submit']);	
						location("add_blog_category.php?mode=edit&id=".$_REQUEST['id']."&msg=4");	
						return;
					}
			...
			<table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
				<td align="left" valign="top" class="middle_right_bg">
					...
					<TR>
					  <TD>
							<form action="add_blog_category.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();">
