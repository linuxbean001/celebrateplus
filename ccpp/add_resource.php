			...
			switch($_REQUEST['mode'])
			{
				case 'add' :
					if(GTG_is_dup_add('blog_posts','blog_title',$blog_title))
					{
						...
						location("add_resource.php?mode=add&msg=4");
						return;
					}
					...
					location("manage_resources.php?msg=1");
				break;
				...
				case 'edit' :
					...
					{
						unset($_REQUEST['Submit']);	
						location("add_resource.php?mode=edit&id=".$_REQUEST['id']."&msg=4");	
						return;
					}
			...
			<table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					  ...
					  <td align="left" valign="middle" class="title_wrapper_middle"><? echo ($_GET["id"]>0)?"Edit":"Add"; ?> Resource</td>
			  ...
			  <tr>
				<td align="left" valign="top" class="middle_right_bg">
					...
					<TR>
					  <TD>
							<form action="add_resource.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="javascript:return keshav_check();">
							...
							<tr>
								  <td width="29%" align="right" class="f-c"><span style="color:#FF0000;">*</span>Resource Title :</td>
							...
							<tr>
								  ...
								  <td width="71%" class="f-c"><select name="category_id" id="category_id" ><option value="-" <? if($category_id == '-'){ ?>selected="selected"<? } ?>>Please Select</option><? $tmp_cmb_array2 = split(",",$category_id); ?><?										
											$add_result2 = hb_get_result("select * from blog_categories") or die(mysql_error());			
							...
							<tr>
							  <td width="29%" align="right" class="f-c"> Summary :</td>
					...
					<textarea name="post_summary" style="width:100%;height:300PX"> <?=$post_summary?></textarea> 
					<script type="text/javascript">
					//<![CDATA[

					var editor = CKEDITOR.replace( 'post_summary' ,{
					...
					CKFinder.setupCKEditor( editor, 'ckeditor/ckfinder/' ) ;
							...
							<?php /*?><?php
								...
								$oFCKeditor5->Create();
							?><?php */?>
					<textarea name="full_content" style="width:100%;height:300PX"> <?=$full_content?></textarea> 
					<script type="text/javascript">
					//<![CDATA[
