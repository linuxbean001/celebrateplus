...
<!-- left menu coding start here -->
<link rel="stylesheet" type="text/css" href="js/sdmenu.css" />
<link href="css/menusite.css" rel="stylesheet" type="text/css" />
<!-- left menu coding over here -->
</head>
            ...
            <td align="left" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="left" valign="middle" class="title_wrapper_middle">Celebrate Plus
                        <? 
							if($_REQUEST["menu_name"] !="" && $_REQUEST["menu_name"] !="Default")
							{	
								echo "( ".$_REQUEST["menu_name"]." )";
							}
						?>                        </td>
                  ...
                  <tr>
                    <td align="left" valign="top" class="middle_right_bg"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                         ...
                         <?
                                 ...
                                 for($i=0;$i<count($HeadLinksArray);$i++)
                                 {
                                        if($DEFAULT_TOP_MENU !="Default")
										{
										  ...
										  <td align="center"  valign="middle" class="box_bg"  ><table width="103"  border="0" cellspacing="0" cellpadding="0" align="center" >
													  <tr>
														<td height="68" align="center" valign="middle"><img src="images/icon/<? echo $LeftLinkAry1[$LeftLinkCount][4] ?>" width="42" height="45" align="middle" /></td>
													  </tr>
													  <tr>
														<td align="center" valign="top"   style="text-align:center"><a href="<? echo $LeftLinkAry1[$LeftLinkCount][1] ?>" class="blue_11_link"><? echo $LeftLinkAry1[$LeftLinkCount][0] ?></a></td>
													  </tr>
													</table></td>
										  ...
										  <?
													if($destop_count%5==0)
													{
														echo '</tr><tr><td height="10px"></td></tr><tr>';
													}
												}
											}
										}
