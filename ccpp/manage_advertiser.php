...
$pagetitle="Advertisers";
	if(isset($_REQUEST['update']))
	{
		...
		for($i = 1;$i <= $count1;$i++)
		{
			...
			$query = "update advertiser set displayorder=".$disp1." where id=".checkNum($_REQUEST[$pid]);
			hb_get_result($query);
			location("manage_advertiser.php?msg=2");
		}
	}
?>
<? 
$sel="select * from advertiser where  name like '".$_GET["order"]."%' order by displayorder";
                ...
                <td align="left" valign="top"><table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <TD align="center"><span style="color:#CC6600;">
                       <?
								if($_GET["msg"]==1)
									echo "Advertiser Added Successfully.";
								elseif($_GET["msg"]==2)
									echo "Advertiser Updated Successfully.";
								elseif($_GET["msg"]==3)
									echo "Advertiser Deleted Successfully.";
								elseif($_GET["msg"]==4)
									echo "Advertiser with this name is already Exist.";	
								elseif($_GET["msg"]==5)
									echo "This Advertiser is in use. You can not delete this Advertiser.";	
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td align="left" valign="middle" class="title_wrapper_middle">Manage Advertisers</td>
                                    ...
                                    <td align="left" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td width="366" class="arial_13_bold"> Title</td>
										   <?php /*?><td width="292" class="arial_13_bold">Image</td>
										   <td width="197" class="arial_13_bold">Display Order</td><?php */?>
										...
										?></td>
										  <td align="center" class="photo"><input onKeyPress="return keycode();" size="3" type="textbox" name="disp<?=$count; ?>" value="<?=$get->displayorder;?>" ><input type="hidden" name="pid<?=$count; ?>" value="<?=$get->id;?>" ></td><?php */?>
                                          <td class="photo"><img src="images/pencil.jpg" width="11" height="11" /> &nbsp;<a href="javascript:;" onClick="window.location.href='add_advertiser.php?id=<?php echo ($get->id); ?>&mode=edit'" class="edit" >Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/delete.jpg" width="10" height="10" /> &nbsp;<a href="javascript:;" onClick="deleteconfirm('Are you sure that you want to delete this advertiser? \n','add_advertiser.php?id=<?php echo ($get->id); ?>&mode=delete')" class="edit" >Delete</a></td>
                                        </tr>
                                        <? } ?>
                                    </table></td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td  valign="middle"><table width="98%" border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tr>
                                          ...
                                          <td align="left"><input type="button" name="button2" id="button2" value="ADD NEW" class="add_new" onclick="location.href='add_advertiser.php?mode=add'" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
