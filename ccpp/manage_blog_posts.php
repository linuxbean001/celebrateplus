<?		 //ALTER TABLE `blog_posts` ADD `is_feature` INT NOT NULL;							
include("connect.php");
		  ...
		  <tr>
			...
			<td align="left" valign="top">
				<table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<? if($_GET["msg"]) { ?>
							<tr>
								...
								elseif($_GET["msg"]==4)
									echo "Blog Post with this name is already Exist.";	
								elseif($_GET["msg"]==5)
									echo "This Blog Post is in use. You can not delete this Blog Post.";	
				...
				<tr>
					...
					<td class="photo">
							<? 
							$field_result2=mysql_query("select * from blog_categories where id in (".$get->category_id.") order by category_name");				
							$field_value_list2="";
				  ...
				  <input name="button" type="button" class="send_form" onClick="window.location.href='add_resource.php?id=<?php echo ($get->id); ?>&mode=edit'" value=" EDIT ">
                    <input name="button2" type="button" class="send_form" onClick="deleteconfirm('Are you sure you want to delete this blog post? \n','add_resource.php?id=<?php echo($get->id); ?>&mode=delete');" value="DELETE">
