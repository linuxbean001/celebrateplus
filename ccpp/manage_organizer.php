...
else if(isset($_REQUEST['sort_date']) and $_REQUEST['sort_date']!='-')
{
	...
	{
		$sel = "select * from organizer order by add_date desc desc";
	}
}
		  ...
		  <tr>
			...
			<td align="left" valign="top">
				...
				<tr>
					...
					<form name="srt_lname" id="srt_lname" action="" method="post">
						<tr>
							...
							<select name="sort_date" id="sort_date" onchange="srt_lname.submit()">
									<option value="-">Select</option>
				...
				<tr>
					...
					<form name="srch_lname" id="srch_lname" action="" method="post">
						<tr>
							<td width="23%"><strong>Username :</strong>&nbsp;&nbsp;
							...
							<td width="24%"><strong> Last Name</strong>&nbsp;&nbsp;
							 ...
							 <td width="28%"><input type="submit" onclick="srch_lname.submit()" name="submit1" id="submit1" class="send_form" value="Search" /></td>
						</tr>
						</form>
				  ...
				  <tr>
					<td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						  ...
						  <td align="left" valign="middle" class="title_wrapper_middle">Manage Organizers</td>
				...
				<tr>
				  ...
				  <input name="button" type="button" class="send_form" onClick="window.location.href='add_organizer.php?id=<?php echo ($get->id); ?>&mode=edit'" value=" EDIT ">
                    <input name="button2" type="button" class="send_form" onClick="deleteconfirm('Are you sure that you want to delete this organizer? \n','add_organizer.php?id=<?php echo($get->id); ?>&mode=delete');" value="DELETE">
					<input name="button2" type="button" class="send_form_big" onClick="window.location.href='view_organizer_detail.php?id=<?php echo ($get->id); ?>'" value="VIEW DETAILS">			<br />
					<?
						$event_ids= '';
						$events_query = "select id from events where oid = '".$get->id."'";
						$events_result = mysql_query($events_query) or die(mysql_error());
					...
					?>
					<input name="button2" type="button" class="send_form_big" onClick="window.location.href='manage_events.php?event_ids=<?php echo ($event_ids); ?>'" value="VIEW EVENTS">
					<input name="button2" type="button" class="send_form_big" onClick="window.location.href='view_organizer_detail.php?id=<?php echo ($get->id); ?>'" value="VIEW FUNDING HISTORY">
                  </td>
								  ...
								  <td  valign="middle">
									<table width="98%" border="0" cellpadding="2" cellspacing="2" align="center">
										<tr>
											...
											<td align="center" width="20"><input type="button" name="button2" id="button2" value="ADD NEW" class="add_new" onclick="location.href='add_organizer.php?mode=add'" /></td>
