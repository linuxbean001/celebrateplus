...
$sel= "select * from sub_admin where lname like '".$_GET["order"]."%' order by lname" ;$result=$prs_pageing->number_pageing($sel,20,10,'N','Y');
			...
			<td align="left" valign="top">
				  ...
				  <tr>
					<td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						  ...
						  <td align="left" valign="middle" class="title_wrapper_middle">Manage Sub Admins</td>
				...
				<tr>
						...
						<td class="arial_13_bold">No.</td>
								<td   class="arial_13_bold">Last Name</td>
						 ...
						 ?>	 
							 ...
							 <td height="49" class="photo"><?=$count;?>.</td>
							  ...
							  <td class="photo"> <strong> <? echo stripslashes($get->lname); ?></strong></td>
							  <td class="photo"> <strong> <? echo stripslashes($get->username); ?></strong></td>
							  <td class="photo"> <strong> <? echo stripslashes($get->email); ?></strong></td><td  align="center"nowrap class="photo" >				 
				  <input name="button" type="button" class="send_form" onClick="window.location.href='add_sub_admin.php?id=<?php echo ($get->id); ?>&mode=edit'" value=" EDIT ">
                    <input name="button2" type="button" class="send_form" onClick="deleteconfirm('Are you sure that you want to delete the selected sub admin? \n','add_sub_admin.php?id=<?php echo($get->id); ?>&mode=delete');" value="DELETE">
                  </td>
                ...
                <? } ?>			
				 ...
				 <input type="hidden" name="count" id="count" value="<?=$count;?>" />   
						...
						<script>
							...
							function chkDelete()
							{
									return confirm("Are you sure that you want to delete the selected sub admins?");
							}
						  </script>
								</td>
							</tr>
