			...
			switch($_REQUEST['mode'])
			{
				case 'add' :
					if(GTG_is_dup_add('organizer','username',$username))
					{
						...
						location("add_account.php?mode=add&msg=4");
						return;
					}
					...
					set display_order='$display_order',add_date='$add_date',password='$password',cpassword='$cpassword',fname='$fname',lname='$lname',email='$email',phone='$phone',payment_method='$payment_method',mstreet_address='$mstreet_address',mapartment='$mapartment',mcity='$mcity',mstate='$mstate',mzip='$mzip',mcountry='$mcountry',mcomments='$mcomments',paypalid='$paypalid',city='$city',state='$state',country='$country',find_us='$find_us',acc_notes='$acc_notes'"; 
				...
				case 'edit' :
					...
					$query = "update organizer set add_date='$add_date',password='$password',cpassword='$cpassword',fname='$fname',lname='$lname',email='$email',phone='$phone',payment_method='$payment_method',mstreet_address='$mstreet_address',mapartment='$mapartment',mcity='$mcity',mstate='$mstate',mzip='$mzip',mcountry='$mcountry',mcomments='$mcomments',paypalid='$paypalid',city='$city',state='$state',country='$country',find_us='$find_us',acc_notes='$acc_notes'"; 
