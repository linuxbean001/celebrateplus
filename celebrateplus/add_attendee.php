...
if(isset($_REQUEST['Submit']))
{
			...
			if(isset($_REQUEST['mode']))
		{
			switch($_REQUEST['mode'])
			{
				...
				if($event_max_cap !="")
				{
					mysql_query("update events set 	space_available = space_available-$tot_addendees where id=$event_id");
				}
					...
					<TR>
					  <TD>
							...
							<tr>
								  ...
								  <?										
											$add_result2 = mysql_query("select * from organizer");			
							...
							<tr>
								  ...
								  <td width="71%" class="f-c">
									...
									<select name="event_id" id="event_id" onchange="show_event_data123(this.value)" >
										...
										$add_result = mysql_query("select * from events where oid=$org_id");
							...
							<tr>
								  ...
								  <?										
											$add_result4 = mysql_query("select * from organizer") ;			
