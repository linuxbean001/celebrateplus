<? 
	...
	$result=hb_get_result("select * from employee where id=".$emp_id);
	...
	$taken_leave_result=hb_get_result("select * from employee_leave where eid=".$emp_id." and leave_type=0 and date1 <='".$leave_renew_date."' and date1 >= '".$last_renew_date."'");
	$total_full_leave_taken=mysql_num_rows($taken_leave_result);
	
	$taken_leave_result1=hb_get_result("select * from employee_leave where eid=".$emp_id." and leave_type=1 and date1 <='".$leave_renew_date."' and date1 >= '".$last_renew_date."'");
	$total_half_leave_taken=mysql_num_rows($taken_leave_result1);
	
	$taken_leave_result2=hb_get_result("select * from employee_leave where eid=".$emp_id." and leave_type=2 and date1 <='".$leave_renew_date."' and date1 >= '".$last_renew_date."'");
