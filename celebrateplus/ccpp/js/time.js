...
//if (navigator.appVersion.indexOf("MSIE") != -1){
//clock.innerHTML = day+com+spc+date+ender+spc+month+spc+year+spc+hrs+col+min+col+sec+apm+spc;
//clock.innerHTML = spc+hrs+col+min+col+sec+apm+spc;
document.getElementById("clock").innerHTML = spc+hrs+col+min+col+sec+apm+spc;
//}
}
