<table width="235" height="413px" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="9" align="left" valign="top"><img src="images/cal1.jpg" width="9" height="77" /></td>
                            <td align="left" valign="top" class="cal2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td height="46" align="center" valign="bottom" class="white_34"><SCRIPT src="js/time.js"></SCRIPT>  </td>
                                </tr>
                                <tr>
                                  <td height="22" align="center" class="grey_13"><?=date('l, dS F Y')?></td>
                                </tr>
                            </table></td>
                            <td width="9" align="left" valign="top"><img src="images/cal3.jpg" width="9" height="77" /></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr>
			  ...
			  ?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="left" valign="top" class="sidebar_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <?
							...
							?>							
							 <tr>
                           			 <td height="30" align="left" valign="middle" class="sidebar_menu"><img src="images/left_arrow.jpg" width="3" height="5" style="padding-bottom:2px;"/>&nbsp;&nbsp;<a href="#" class="sidebar_link"><strong><? echo $LeftLinkAry1[$LeftLinkCount][0] ?></strong></a></td>
                          	</tr>
							<?
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="10" align="left" valign="top"><img src="images/sidebar_bottom_1.jpg" width="10" height="10" /></td>
                            <td align="left" valign="top" class="sidebar_bottom">&nbsp;</td>
                            <td width="10" align="left" valign="top"><img src="images/sidebar_bottom_3.jpg" width="10" height="10" /></td>
                          </tr>
                      </table></td>
                    </tr>
                </table></td>
