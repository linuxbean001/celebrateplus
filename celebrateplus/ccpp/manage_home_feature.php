...
$pagetitle="Home Page Features";
	if(isset($_REQUEST['update']))
	{
		...
		for($i = 1;$i <= $count1;$i++)
		{
			...
			$query = "update home_feature set displayorder=".$disp1." where id=".checkNum($_REQUEST[$pid]);
			hb_get_result($query);
			location("manage_home_feature.php?msg=2");
		}
	}
?>
<? 
$sel="select * from home_feature where  name like '".$_GET["order"]."%' order by displayorder";
                    ...
                    <tr>
                      <TD align="center"><span style="color:#CC6600;">
                       <?
								...
								elseif($_GET["msg"]==4)
									echo "Feature with this name is already Exist.";	
								elseif($_GET["msg"]==5)
									echo "This Feature is in use. You can not delete this Feature.";	
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td align="left" valign="middle" class="title_wrapper_middle">Manage Home Page Features</td>
                                  ...
                                  <tr>
                                    <td align="left" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td width="366" class="arial_13_bold"> Title</td>
										   <td width="292" class="arial_13_bold">Image</td>
											<td width="197" class="arial_13_bold">Display Order</td>
											<td width="131" class="arial_13_bold">Actions</td>
                                        </tr>
										...
										$image_path= $get->image_path;
											...
											{
											?>
												<img alt="image" src="../include/sample.php?nm=../home_feature_images/<?=$image_path;?>&mwidth=80&mheight=80" border="0" >
											<?											
											}
										?></td>
										  <td align="center" class="photo"><input onKeyPress="return keycode();" size="3" type="textbox" name="disp<?=$count; ?>" value="<?=$get->displayorder;?>" ><input type="hidden" name="pid<?=$count; ?>" value="<?=$get->id;?>" ></td>
                                          <td class="photo"><img src="images/pencil.jpg" width="11" height="11" /> &nbsp;<a href="javascript:;" onClick="window.location.href='add_home_feature.php?id=<?php echo ($get->id); ?>&mode=edit'" class="edit" >Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/delete.jpg" width="10" height="10" /> &nbsp;<a href="javascript:;" onClick="deleteconfirm('Are you sure that you want to delete this feature? \n','add_home_feature.php?id=<?php echo ($get->id); ?>&mode=delete')" class="edit" >Delete</a></td>
                                        </tr>
                                        <? } ?>
                                    </table></td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td  valign="middle"><table width="98%" border="0" cellpadding="0" cellspacing="0" align="center">
                                        <tr>
                                          ...
                                          <td align="left"><input type="button" name="button2" id="button2" value="ADD NEW" class="add_new" onclick="location.href='add_home_feature.php?mode=add'" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="add_new" type="submit" name="update" value="UPDATE" ></td>
