		  ...
		  <tr>
			...
			<td align="left" valign="top">
				<table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<? if($_GET["msg"]) { ?>
							<tr>
								...
								<?
								if($_GET["msg"]==1)
									echo "Resource Category Added Successfully.";
								elseif($_GET["msg"]==2)
									echo "Resource Category Updated Successfully.";
								elseif($_GET["msg"]==3)
									echo "Resource Category Deleted Successfully.";
								elseif($_GET["msg"]==4)
									echo "Resource Categorywith this name is already Exist.";	
								elseif($_GET["msg"]==5)
									echo "This Resource Category is in use. You can not delete this Resource Category.";	
				  ...
				  <tr>
					<td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						  ...
						  <td align="left" valign="middle" class="title_wrapper_middle">Manage Resource  Categories</td>
				...
				<tr>
				  ...
				  <input name="button" type="button" class="send_form" onClick="window.location.href='add_resource_category.php?id=<?php echo ($get->id); ?>&mode=edit'" value=" EDIT ">
                    <input name="button2" type="button" class="send_form" onClick="deleteconfirm('Are you sure you want to delete this resource category?\n','add_resource_category.php?id=<?php echo($get->id); ?>&mode=delete');" value="DELETE">
                  </td>
								  ...
								  <td  valign="middle">
									<table width="98%" border="0" cellpadding="2" cellspacing="2" align="center">
										<tr>
											...
											<td align="center" width="20"><input type="button" name="button2" id="button2" value="ADD NEW" class="add_new" onclick="location.href='add_resource_category.php?mode=add'" /></td>
