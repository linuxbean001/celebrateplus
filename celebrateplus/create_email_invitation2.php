		...
		<div id="confirmOverlay" style="display: none;">
			<div id="confirmBox">
				...
				<div id="confirmButtons">
					...
					<a class="button" href="javascript:;" onClick="javascript:hide_this(),hb_sharing_a_text_new('<?php echo $fb_link?>','<?php echo $event_title; ?>','<?php echo $site_logo;?>','<?php echo addslashes($fb_message);?>')">Send Message to Your Friend</a>
				</div>
			</div>
		</div>
