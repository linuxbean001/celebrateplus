      ...
      <span style='font-size:18px;font-weight:normal;'>Tell Others About Your Event</span>
        ...
        <div class='grid-5-12 clear'>
          ...
          <div id='invitationDesignDiv' class='invitationGroup'>
            ...
            <select id='invitiationDesign' name='invitation_design_style'>
        ...
        <div class='grid-5-12 invitationGroup' id='designPreviewGroup'>
        <div id='designPreviewDiv'>
          <br/><br/><br/>
          <img id ='designPreview' src='invitation_design_images/image_design1.png' style='max-width:300px;max-height:250px;' />
        </div>

        <div id='personal_photo_div' style='display:none;'>
        ...
        <div class="grid-4-12 clear">
         ...
         <div class="grid-4-12" style='margin:0;padding:0;margin-left:10%;'>
        ...
        <div class="grid-2-12 clear sendVia">
        ...
        <div class='grid-2-12 sendVia' style='margin-left:20px;'>
