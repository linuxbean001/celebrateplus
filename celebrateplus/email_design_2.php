<?
$mail_body='
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" background="'.$SITE_SECURE_URL.'images/email/back2.jpg" >
	<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="center" valign="top" width="590" background="'.$SITE_SECURE_URL.'images/email/trnce.png" style="padding:50px 0px; width:590px;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td  align="center" valign="top" style="font-family:Palatino Linotype; font-size:60px; color:#0092c3; ">'.$event_mail_header.'<br /><a href="https://www.celebrateplus.com/event_detail.php?eve_id='.$event_id.'" style="font-family:Palatino Linotype; font-size:43px; color:#88b130; text-decoration:none;">'.$event_name.'</a></td>
							</tr>
							<tr>
