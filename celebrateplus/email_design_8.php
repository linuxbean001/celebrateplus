<?
$mail_body='
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0"  background="'.$SITE_SECURE_URL.'images/email/bg_img.jpg">
  <tr>
    <td align="center" valign="middle" style="height:505px; padding:80px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
        ...
        <tr>
          <td align="center" valign="middle" ><a href="https://www.celebrateplus.com/event_detail.php?eve_id='.$event_id.'" style="font-family:Georgia, Times New Roman, Times, serif; font-size:42px; color:#53432a; text-decoration:none;">'.$event_name.'</a></td>
        </tr>
        <tr>
          <td align="center" valign="middle">&nbsp;</td>
        </tr>
        <tr>
          <td align="center" valign="middle" style="font-family:Georgia, Times New Roman, Times, serif; font-size:16px; color:#000000; line-height:30px;">'.$invitation_message.'</td>
        </tr>';
