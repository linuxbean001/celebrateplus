                    	...
                    	<div class="tab_box_bg_inner">
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px;">
                            	<div class="tab_box_bg_inner_left_text_regconf">
                                	<div class="eve_text_main">
                                        <div style="width:100px; text-align:right; float:left;"><span>When:</span></div> 
										<div style="width:820px; float:left; padding-left:10px;"><?=$day?> <?=$month?> <?=$dd?>, <?=$year?> at <?=$event_stime;?> until <?=$day1?> <?=$month1?> <?=$dd2?>, <?=$year1?> at <?=$event_etime;?></div>
                                        <div style="width:100px; text-align:right; float:left;"><span>Where:</span></div> 
										<div style="width:820px; float:left; padding-left:10px;">
                                        ...
                                        <div style="width:100px; text-align:right; float:left;"><span>Space Left:</span></div>
										<div style="width:820px; float:left; padding-left:10px;"><?=$event_space_available?></div>
                                    </div>
                                    ...
                                    <div class="eve_text_main_form">
                                    	<div class="eve_text_main_form_in_main">
                                        	<div class="eve_text_main_form_name" style="text-align:left;">How Many People Are Attending?<span style="color:#FF0000;">*</span><br /><span style="font-size:12px; line-height:15px; padding-right:5px; font-style:italic; text-align:left; color:#FF0000;">Include yourself in the number of people attending.</span></div>
                                            <div class="eve_text_main_form_input_box">
                                            	<div class="eve_text_main_form_input"><input type="text" name="tot_addendees" id="tot_addendees" onblur="show_confirm_box(this.value)" /></div>
                                            </div>
                                        </div>
                                        <div class="eve_text_main_form_in_main">
                                        	<div class="eve_text_main_form_name">Comments / Message :</div>
                                            <div class="eve_text_main_form_input_box">
                                            	<div class="eve_text_main_form_input_tr"><textarea name="comments" id="comments"></textarea></div>
                                            </div>
                                        </div>
										<?
...
<script type="text/javascript">
			...
			function show(ans)
			{
				...
				{	
					...
					document.getElementById("confirm_event_frm").action='make_payment2.php';
				}
				else
				{
