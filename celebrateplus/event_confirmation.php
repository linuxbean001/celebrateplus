...
/*=============================================================================================================*/	
	...
	$how_mch = str_replace(",","",$_REQUEST['how_mch']);
	...
	unset($_SESSION['session_gave_to_site']);
	unset($_SESSION['session_gave_to_event_owner']);
	unset($_SESSION['session_commission_rate']);
...
/*=======================================================================================================================*/
	...
	<tr>
		<td colspan=2>
			<div align="right" colspan="4" nowrap="nowrap"><strong>Your attendance has been confirmed to '.$event_nm.'. Your event details can be found below:</strong></div></td>
	...
	<tr>
		...
		<td><div align="left">'.$event_nm.' </div></td>
	</tr>
	
	<tr>
		<td>
		<div align="right"><strong>Start Date: </strong></div></td>
		<td><div align="left">'.convert_us($event_sdate).' </div></td>
	</tr>
	<tr>
		<td>
		<div align="right"><strong>Start Time: </strong></div></td>
		<td><div align="left">'.$event_stime.' </div></td>
	</tr>
	
	<tr>
		<td>
		<div align="right"><strong>End Date: </strong></div></td>
		<td><div align="left">'.convert_us($event_edate).' </div></td>
	</tr>
	<tr>
		<td>
		<div align="right"><strong>End Time: </strong></div></td>
		<td><div align="left">'.$event_etime.' </div></td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td><div align="left">'.$event_loc_name.'<br />'.$event_loc_street.'&nbsp;'.$event_loc_suit.'<br />
		'.$event_loc_city.'&nbsp;'.$event_loc_state.'&nbsp;'.$event_loc_zip.'&nbsp;'.$event_loc_country.'
...
/*=========Email to the founder or organizer of the event=============*/
	$body1='<table width="523" border="0" cellpadding="2" cellspacing="2" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;">
	<tr>
		<td colspan=2>
			<div align="right" colspan="4" nowrap="nowrap"><strong>'.$org_fname.' '.$org_lname.' has confirmed their attendance to '.$event_title.'</strong></div></td>
	...
	<tr>
		<td>
		<div align="right"><strong>Total Attendees: </strong></div></td>
	...
	<tr>
		<td>
		<div align="right"><strong>Funding: </strong></div></td>
		<td><div align="left">'.$funding.' </div></td>
	</tr>
	<tr>
		<td>
		<div align="right"><strong>Funding Amount: </strong></div></td>
		<td><div align="left">'.$how_mch.' </div></td>
	</tr>
	
	<tr>
		<td>
		<div align="right"><strong>Confirmation Comments: </strong></div></td>
		<td><div align="left">'.stripslashes($comments).' </div></td>
	</tr>
...
/*=======================================*/
//$user_id = $_SESSION['SESS_USER_ID'];
//$user_info = hb_get_result("select * from user where id=");
?>
            ...
            <div class="middle_inner">
            	<div class="tab_box_main">
                	<div class="tab_box_title_main">
                    	<div class="inner_title_bg">Thank you for confirming your attendance to <?=str_replace("\\","",$event_nm);?></div>
                    </div>
                    <div class="tab_box_bg_main">
						<div class="myacc_menu_main" style="height:40px;">
                        	<? include("account_menu.php");?>
                        </div>
                    	<div class="tab_box_bg_inner">
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px;">
								<? if($is_attendee == 1){ ?>
                            	<div class="tab_box_bg_inner_left_text_regconf">Your attendance to the event <?=str_replace("\\","",$event_nm);?> has been confirmed. To view the event details in the future please view the <a href="event_attending.php">Events I'm Attending</a> tab within your account.</div>
								<?
									}else{
								?>
								<div class="tab_box_bg_inner_left_text_regconf">Thanks for your contribution for the event <?=str_replace("\\","",$event_nm);?>.</div>
								<?
									}
								?>
                            </div>
