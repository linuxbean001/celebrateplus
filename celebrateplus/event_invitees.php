                        	...
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
                                ...
                                <div class="events_page_main">
                                	<div class="events_page_title_main">
                                    	<div class="events_page_title_eve2" style="width:180px;">Date Invited</div>
                                        <div class="events_page_title_date" style="width:350px;">Email Address</div>
                                        <div class="events_page_title_location" style="width:175px;">Attendance</div>
                                    ...
                                    <div class="events_page_addtop_main">
                                    	...
                                    	<div class="events_page_add_main">
                                        	<div class="events_page_add_eve2" style="width:180px;">
											<? echo convert_us($inv_row['add_date']); ?>
											</div>
                                            <div class="events_page_add_date" style="width:360px;">
											<? echo stripslashes($inv_row['email']); ?>											
											</div>
                                            <div class="events_page_add_location" style="width:175px;">
											 <?
