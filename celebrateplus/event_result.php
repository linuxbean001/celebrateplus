...
<? 
	...
	/*"select title,sdate,edate,loc_name,oid,searchable,fname,events.id,lname from events left join organizer on events.oid=organizer.id
				where events.searchable='yes' and (title like '%".$eve_nm."%' or fname like '%".$fname."%' or lname like '%".$lname."%')";*/
	$eve_res = hb_get_result($eve_qry);
?>
                    ...
                    <div class="tab_box_bg_main">
                    	<div class="tab_box_bg_inner">
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
								...
								<form name="Search_Events" id="Search_Events" action="event_result.php" method="post" onsubmit="javascript: return login_chk()">
                                ...
                                <div class="events_page_main">
									...
									<?php 
										...
										{	
											//$redirect_url = "acc_event_detail.php?eve_id=".$eve_id;	
											$redirect_url = "event_detail.php?eve_id=".$eve_id;
										}
										else
										{	$redirect_url = "event_detail.php?eve_id=".$eve_id;	}
									?>
                                    	<tr class="events_page_addtop_main" style="padding-left:20px; border-bottom:1px solid #D9D9D9;">
											<td class="event_td1 event_data_style">
												<a href="<?=$redirect_url;?>"><?=str_replace("\\","",$eve_title);?></a>
											</td>
											...
											<td class="event_td5 event_data_style">												
												<a href="<?=$redirect_url;?>"><img src="images/vew_event.png" /></a>
											</td>
										</tr>
