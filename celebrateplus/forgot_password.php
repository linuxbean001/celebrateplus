                                ...
                                <div class="reg_wid_form_main" style="padding:0;">
									...
									<?php } ?>
										<form name="frm" method="post" action="forgot_password.php" onsubmit="javascript:return fp_empty_chk();">
                                			<div class="reg_wid_form_input_main" style="width:550px;">
												<div class="reg_wid_form_name" style="width:205px;">Enter your email address :</div>
												<div class="reg_wid_form_input_box">
													<div class="reg_wid_form_input"><input type="text" name="email" id="email" value=""  /></div>
												</div>
											</div>
											<div class="reg_wid_form_input_main" style="width:550px;">
												<div class="reg_wid_form_name" style="width:205px;">&nbsp;</div>
												<div class="reg_wid_form_input_box">
