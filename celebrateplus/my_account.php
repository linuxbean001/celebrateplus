                                ...
                                <div class="reg_wid_form_main">
                                	...
                                	<div class="reg_wid_form_input_main">
                                        ...
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input name="email"  type="text" id="email" value="<?=$email; ?>" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name">Password<span style="color:#FF0000;">*</span> :</div>
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input name="password" type="password" id="password" value="<?=$password; ?>" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name">Confirm Password<span style="color:#FF0000;">*</span> :</div>
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input type="password" name="cpassword" id="cpassword" value="<?=$password?>" /></div>
                                        </div>
                                    </div>
									<div class="reg_wid_form_input_main">
                                        ...
                                        <div class="reg_wid_form_input_box">
											<div style="width:250px;">
                                        		<div class="reg_wid_form_input"><input type="text" name="paypalid" id="paypalid" value="<?=$paypalid?>" /></div>
									...
									<div class="reg_wid_form_input_main" style="padding-bottom:0px;">
                                        ...
                                        <div class="reg_wid_form_input_box" style="height:20px;"><a href="payment_setup.php" class="common_link">How do I create my PayPal account?</a>
                                        </div>
                                    </div>
                                	...
                                	<div class="reg_wid_form_input_main">
                                        ...
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input name="fname"  type="text" id="fname" value="<?=$fname; ?>" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name">Last Name<span style="color:#FF0000;">*</span> :</div>
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input name="lname"  type="text" id="lname" value="<?=$lname; ?>" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name">Phone :</div>
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input name="phone" size="30" type="text" id="phone" value="<?=$phone; ?>" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name">City :</div>
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input name="city" type="text" id="city" value="<?=$city; ?>" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
