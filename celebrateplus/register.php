                    ...
                    <div class="tab_box_bg_main">
						...
						<input type="hidden" name="eve_id" id="eve_id" value="<?=$_REQUEST['eve_id'];?>">
                                ...
                                <div class="reg_wid_form_main">
                                    ...
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name"><span style="margin-left:-6px;">Confirm Password</span><span style="color:#FF0000;">*</span> :</div>
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input type="password" name="cpassword"  id="cpassword" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name"><input type="checkbox" name="opted_email" id="opted_email" value="true" /></div>
                                        <div class="reg_wid_form_input_box">
	                                       <div class="reg_btn_main" style="width:250px; padding-top:0px; line-height:20px;"> I would like to receive special offers, notifications and updates from CelebratePlus</div> 
                                       </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name">&nbsp;</div>
                                        <div class="reg_wid_form_input_box">
	                                       <div class="reg_btn_main"><input type="image" name="submit" id="submit" src="images/reg_btn.png" /></div> 
                                       </div>
                                    </div>
                                    </div>
                                	...
                                	<div class="reg_wid_form_input_main">
                                        ...
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input type="text" name="fname" id="fname" /></div>
                                        </div>
                                    </div>
                                    <div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name">Last Name<span style="color:#FF0000;">*</span> :</div>
                                        <div class="reg_wid_form_input_box">
                                        	<div class="reg_wid_form_input"><input type="text" name="lname" id="lname" /></div>
                                        </div>
                                    </div>
									<div class="reg_wid_form_input_main">
