                                ...
                                <div class="events_page_main">
									<table cellpadding="0" cellspacing="0" border="0" width="935">
										<tr class="events_host_title_tr">
											<td width="20"></td>
											<td class="event_host_td1 event_title_style" style="border:none;">Event Name</td>
											<td class="event_host_td2 event_title_style" style="border:none;">Date</td>
											<td class="event_host_td3 event_title_style" style="border:none;">Location</td>
											<td class="event_host_td4 event_title_style" style="border:none;">Attendees</td>
											<td class="event_host_td5 event_title_style" style="border:none;">Funded</td>
											<td class="event_host_td6 event_title_style" style="border:none;"></td>
										</tr> 
									<?
...
$currently_funded_amount = number_format($currently_funded_amount,2);
									...
									?>
                                    	<tr class="events_host_data_tr">
											...
											<td class="event_host_td4 event_data_style"><?=$eve_attende?></td>
											<td class="event_host_td5 event_data_style">$<?=$currently_funded_amount;?></td>
											<td class="event_host_td6 event_data_style"><select name="action" onChange="implement_access(this.value,'<?=$eve_id;?>')" >
