            	...
            	<div class="tab_box_main">
                    ...
                    <?											
                                    ...
                                    <div class="reg_wid_form_input_main">
                                    	...
                                    	<div class="form_login_title" style="padding-left:25px; padding-top:70px;">Location</div>                                    
                                	<div class="reg_wid_form_input_main">
                                	...
                                	<div class="cplus_acctcreateevent_right">
                                        ...
                                        <div class="form_login_title" style="padding-top:28px;">Event Funding</div>
                                    </div>
                                    ...
                                    <div class="cplus_acctcreateevent_right">
                                        <div class="form_login_title" style="padding-top:28px;">Event Privacy</div>
                                    </div>
                                    <div class="reg_wid_form_left">
                                    <div class="reg_wid_form_input_main" style="padding:0 0 15px 45px;">
                                    	<div class="reg_wid_form_name" style="text-align:left;">
