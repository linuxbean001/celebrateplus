                        	...
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
                                ...
                                <div class="cplus_acctcreateevent">
                                	...
                                	<div class="reg_wid_form_input_main">
                                    	<div class="reg_wid_form_name" style="width:100%; font-weight:normal; text-align:left; line-height:normal; font-size:14px;">If you currently do not have a PayPal account, you can signup for PayPal easily by following the link below. Once you complete your PayPal setup you can then add your PayPal account to your CelebratePlus account and you can start accepting event donations online.</div>
                                    </div>
									<div class="reg_wid_form_input_main">
                                	...
                                	<div class="cplus_acctcreateevent_right">
                                    	...
                                    	<div class="cplus_acctcreateevent_input_main" style="padding-bottom:0px;">
                                        	<div class="cplus_acctcreateevent_name" style="width:100%; font-weight:normal; text-align:left; line-height:normal; font-size:14px;">Already have a PayPal account? Connect your PayPal account to your CelebratePlus account by entering the email address that you used when registering with PayPal into the My PayPal Account field below. Once you have connected your PayPal account to your CelebratePlus account you can start accepting event donations online and the funds will be directly deposited into your PayPal account on record.</div>
                                           
                                        </div>
                                        <div class="reg_wid_form_input_main">										
                                    		<div class="reg_wid_form_name" style="text-align:left; width:250px; float:left;">
                                        	...
                                        	<div class="reg_wid_form_input_box">
												<div style="width:250px;">
                                        			<div class="reg_wid_form_input"><input name="paypalid" type="text" id="paypalid" value="<?=$GBV_CURRENT_USER_PAYPAL_ID;?>"  <?php /*?><? if($GBV_CURRENT_USER_PAYPAL_ID != ''){ ?> readonly="true" disabled="disabled"<? } ?><?php */?> /></div>
									...
									<div class="cplus_acctcreateevent_right" style="margin:0px; padding:0px;">
                                    	<div class="cplus_acctcreateevent_input_main">
                                        	<div class="cplus_acctcreateevent_name"><input type="image" name="save" id="save" src="images/save.png" /></div>
