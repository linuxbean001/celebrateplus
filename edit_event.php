                        	...
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
                                ...
                                <div class="col-sm-12">
                                	...
                                	<div class="form-group">
                                    	<div>Event Title<span style="color:#FF0000;">*</span> :</div>
                                        	<input name="title" type="text" class="form-control" id="title" value="<?=$title?>" />
                                    </div>
									<div class="form-group">
                                    	<div>Event Page Image :</div>
                    ...
                    <?											
                                    ...
                                    <div class="form-group">
                                    	<div >Event Start Date :</div>
                                            	<input name="sdate" class="form-control" type="text" id="sdate" readonly="true" style="width: 90%; float: left;" value="<? if( $sdate != "0000-00-00"){ echo get_cplus_date($sdate); }?>"  />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="stime" type="text" class="form-control" id="stime" value="<?=$stime?>" />
                                       
                                    </div>
                                    <div class="form-group">
                                    	<div>Event End Date :</div>
											<input name="edate" type="text" class="form-control" style="width:90%;float: left;" id="edate" value="<? if( $edate != "0000-00-00"){ echo get_cplus_date($edate); }?>" />
                                    ...
                                    <div class="form-group">
                                    	<div>Event End Time :</div>
                                        	<input name="etime" type="text" class="form-control" id="etime" value="<?=$etime?>" />
                                      
                                    </div>
                                    <div class="form-group">
                                    	<div>Maximum Capacity :</div>
                                        	<input name="max_cap" type="text" id="max_cap" value="<?=$max_cap?>" class="form-control" />
                                    </div>

                                    <div class="form_login_title">Location</div>                                    
                                	<div class="form-group">
                                    	<div>Name :</div>
                                        	<input name="loc_name" type="text" value="<?=$loc_name?>" id="loc_name" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    	<div>Street Address :</div>
                                        <input name="loc_street" type="text" value="<?=$loc_street?>" id="loc_street" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    	<div>Suite # or Apt # :</div>
                                        <input name="loc_suite" type="text"  value="<?=$loc_suite?>" id="loc_suite" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    	<div>City :</div>
                                       <input name="loc_city" type="text" id="loc_city" value="<?=$loc_city?>" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    	<div>State / Province :</div>
                                        <input name="loc_state" type="text" id="loc_state" value="<?=$loc_state?>" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    	<div>Zip / Postal Code :</div>
                                        <input name="loc_zip" type="text" id="loc_zip" value="<?=$loc_zip?>" class="form-control" />
                                    </div>
                                    <div class="form-group">
                                    	<div>Country :</div>
                                        <input name="loc_country" type="text" id="loc_country" class="form-control" value="<?=$loc_country?>" />
                                    </div>
                                    <div class="form-group">
                                    	<div>Map Link :</div>
                                        	<input name="map_link" class="form-control" type="text" id="map_link" value="<?=$map_link?>" />
                                    </div>
                                	...
                                	<div class="col-sm-6">
                                    	...
                                    	<div class="form-group">
                                        	<div>Summary<span style="color:#FF0000;">*</span> :</div>
                                            <textarea name="summary121" id="summary121" class="form-control"><?=$summary?></textarea>
                                        </div>
                                        <div class="form-group">
                                        	<div>Full Description :</div>
                                            	<textarea class='editor form-control' name="description121" id="description121"><?=$description?></textarea>
                                        </div>
                                        <div class="form_login_title">Event Funding</div>
                                        <div class="form-group">
                                    		<div>I would like to accept funding for this event<span style="color:#FF0000;">*</span> :</div>
                                        	<select class="form-control" name="fund_allowed" id="fund_allowed" onChange="show(this.value)" >
                                    ...
                                    <div style="<? if($fund_allowed != "Yes"){?>display:none;<? } ?>" id="funding_attributes">
									<div class="form-group">
                                    	<div>PayPal ID<span style="color:#FF0000;">*</span> :</div>
												<input name="paypalid" type="text" class="form-control" id="paypalid" value="<?=$GBV_CURRENT_USER_PAYPAL_ID;?>" />
                                    ...
                                    <div class="form-group">
                                    	<div>Target Funding Amount :</div>
                                        	<input name="fund_amt" class="form-control" type="text" id="fund_amt" value="<?=$fund_amt;?>" />
                                    </div>
                                    <div class="form-group">
                                    	<div>Minimum Donation Amount :</div>
                                        	<input name="max_don_amt" class="form-control" type="text" id="max_don_amt" value="<?=$max_don_amt;?>"  />
                                    </div>
									 <?
									  ...
									  ?>
                                    <div class="form-group">
                                    	<div>Funding Close Date :</div>
											<input name="fund_end_date" class="form-control" style="width: 90%; float: left;" type="text" id="fund_end_date" value="<? if( $fund_end_date != "0000-00-00"){ echo get_cplus_date($fund_end_date); }?>" />
									...
									<div class="form-group">
                                        <span><input type="checkbox" name="donate_to_attend" id="donate_to_attend" value="yes" <? if($donate_to_attend == "yes"){?> checked="checked"<? } ?> /></span>All attendees must donate to attend
                                    </div>
									<div class="form-group">
                                        <span><input type="checkbox" name="define_donation_levels" id="define_donation_levels" onChange="javascript:show_defin_d_level();" value="yes" <? if($define_donation_levels == "yes"){ ?> checked="checked" <? } ?>/></span>I would like to define donation levels
                                    </div>
									<div id="defin_d_level" style="<? if($define_donation_levels == "yes"){ ?> <? } else { ?>  display:none; <? } ?>">
									<div class="form-group">
                                    	<div>Friend :</div>
                                        	<input name="df_friends" class="form-control" type="text" id="df_friends" value="<?=$df_friends;?>" />
                                    </div>
									<div class="form-group">
                                    	<div>Bronze :</div>
											<input name="df_bronze" class="form-control" type="text" id="df_bronze"  value="<?=$df_bronze;?>"/>
                                    </div>
									<div class="form-group">
                                    	<div>Silver :</div>
										<input name="df_silver" class="form-control" type="text" id="df_silver" value="<?=$df_silver;?>" />
                                    </div>
									<div class="form-group">
                                    	<div>Gold :</div>
										<input name="df_gold" class="form-control" type="text" id="df_gold" value="<?=$df_gold;?>" />
                                    </div>
									<div class="form-group">
                                    	<div>Platinum :</div>
										<input name="df_platinum" class="form-control" type="text" id="df_platinum" value="<?=$df_platinum;?>"/>
                                    </div>
									<div class="form-group">
                                    	<div>Benefactor :</div>
										<input name="df_benefactor" class="form-control" type="text" id="df_benefactor" value="<?=$df_benefactor;?>"/>
                                    </div>
									</div>
									</div>
									
                                   
                                    <div class="form_login_title">Event Privacy</div>
                                 
                                 
	                                    <div class="form-group">
	                                        <span><input type="checkbox" name="searchable" <? if($searchable=='yes'){?> checked="checked"<? }?> id="searchable" value="yes" /></span>Allow this event to be searchable
	                                    </div>
	                                    <div class="form-group">
	                                        <span><input type="checkbox" name="display_fund" id="display_fund" <? if($display_fund=='yes'){?> checked="checked"<? }?> value="yes" /></span>Display funding details on event details page
	                                    </div>
										<div class="form-group">
	                                        <span><input type="checkbox" name="attendee_list_public" id="attendee_list_public" value="yes" <? if($attendee_list_public == "yes"){ ?> checked="checked" <? } ?> /></span>Make attendee list public
	                                    </div>
                                    </div>
