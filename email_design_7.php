<?php
$mail_body='
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" background="'.$SITE_SECURE_URL.'images/email/back7.jpg" >
  <tr>
    <td align="center" valign="top" style="padding-top:150px; padding-bottom:260px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="top" width="590" background="'.$SITE_SECURE_URL.'images/email/trnce.png" style="padding:50px 0px; width:590px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td  align="center" valign="top" style="font-family:Palatino Linotype; font-size:60px; color:#19133f; ">'.$event_mail_header.'<br />
                  <a href="https://www.celebrateplus.com/event_detail.php?eve_id='.$event_id.'" style="font-family:Palatino Linotype; font-size:43px; color:#0d3a71; text-decoration:none;">'.$event_name.'</a></td>
              </tr>
              <tr>
...
if($event_mail_IR == "Invitation")
{
 $mail_body.='<tr>
				...
				<a href="https://www.celebrateplus.com/event_detail.php?eve_id='.$event_id.'" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#19133f; text-decoration:none;">View Event</a>
				</td>
			  </tr>';
}
else if($event_mail_IR == "Reminder")
{
 $mail_body.='<tr>
				...
				'.$organizer_first_name.' '.$organizer_last_name.' would like to remind you about '.$event_name.'. To view the event details <a href="https://www.celebrateplus.com/event_detail.php?eve_id='.$event_id.'" style="color:#19133f; text-decoration:none;">click here</a>.
				</td>
			  </tr>';
}
$mail_body.='</table></td>
