                    	...
                    	<div class="tab_box_bg_inner">
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
                                ...
                                <div class="col-md-12">
                                	...
                                	<div class="col-md-6">
                                    	<div class="form_login_title">Create Your Invitation</div>
                                
                                    	<div>Select the design for your invitation: <span style="color:#FF0000;">*</span></div>
									...
									<div class="form-group">
                                    	<div style="float:left;">Enter your personal message: </div>
                                    </div>
									<div class="form-group">
									...
									<div id="priview_image_div12" style="display:none;">
									 ...
									 <div class="form-group">
                                    	<div>Enter the email addresses of the people you would like to invite below.<br /> Separate each of the email addresses by a comma:</div>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="invitees" id="invitees" class="form-control"></textarea>
                                    </div>
