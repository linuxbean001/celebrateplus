    ...
    <body style="background:none;">
		...
		<div class="tab_box_bg_inner_left_text_regconf" style="padding:15px; width:auto;">
			<?php 
				...
				{
					echo "Your selected Facebook friends have been invited to your event. Close this window and invite others using your other social networks, or continue on to your CelebratePlus dashboard.";
				}
			?>
			<!--Your selected Facebook friends have been invited to your event. Close this window and invite others using your other social networks, or continue on to your CelebratePlus dashboard.-->
		</div>            
    </body>
</html>
