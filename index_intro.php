...
<div class="main">
	<div class="margin">
		<div class="min">
			...
			<div class="logo_bot_tex_black">Stay informed, receive updates and get notified<br />when we launch in Summer 2012:</div>
			<?
			if($_REQUEST['msg'] == 1)
			{
			?>
			<div class="logo_bot_tex_black" style="padding-bottom:10px; color:#FF0000;">Thenk you for sign up.</div>
			<?
			}
			?>
			<?
