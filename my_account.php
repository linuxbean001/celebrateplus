            	...
            	<div class="tab_box_main">
                    ...
                    <div class="tab_box_bg_main">
                    	...
                    	<div class="tab_box_bg_inner">
                        	<div class="tab_box_bg_inner_regconf">
                            	<div class="tab_box_bg_inner_left_text_regconf"><?=$a[1]?></div>
								<? if($_REQUEST['msg']==1){?>
								<div class="tab_box_bg_inner_left_text_regconf">Your account details have been updated successfully.</div>
								<? }?>
                                ...
                                <div class="col-sm-12">
                                	...
                                	<div class="form-group">
                                    	<div class="">Email<span style="color:#FF0000;">*</span> :</div>
                                        	<input name="email_id"  type="text" id="email_id" value="<?=$email; ?>" class="form-control" />
                                       
                                    </div>
                                    <div class="form-group">
                                    	<div class="">Password<span style="color:#FF0000;">*</span> :</div>
                                        <input name="password1" type="password" id="password1" value="<?=$password; ?>" class="form-control" />
                                       
                                    </div>
                                    <div class="form-group">
                                    	<div class="">Confirm Password<span style="color:#FF0000;">*</span> :</div>
                                        <input type="password" name="cpassword1" id="cpassword1" value="<?=$password?>" class="form-control" />
                                    </div>
									<div class="form-group">
                                    	<div class="">PayPal ID :</div>
                                        		<input type="text" name="paypalid" id="paypalid" value="<?=$paypalid?>" class="form-control" />
												<div>
									...
									<div class="form-group">
                                        <a href="payment_setup.php" class="common_link">How do I create my PayPal account?</a>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    	<input type="checkbox" name="opted_email" id="opted_email" value="true" <?php if($opted_email == "true"){?> checked="checked" <?php } ?> />
                                    ...
                                    <div class="col-sm-6">
                                	<div class="form-group">
                                    	<div class="">First Name<span>*</span> :</div>
                                        	<input name="fname"  type="text" id="fname" value="<?=$fname; ?>" class="form-control" />
                                       
                                    </div>
                                    <div class="form-group">
                                    	<div class="">Last Name<span>*</span> :</div>
                                        	<input name="lname"  type="text" id="lname" value="<?=$lname; ?>" class="form-control" />
                                       
                                    </div>
                                    <div class="form-group">
                                    	<div class="">Phone :</div>
                                        	<input name="phone" size="30" type="text" id="phone" value="<?=$phone; ?>" class="form-control" />
									...
									<div class="form-group">
                                    	<div class="">Country<span style="color:#FF0000;">*</span> :</div>
