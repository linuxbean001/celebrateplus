                        	...
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
                                ...
                                <div class="cplus_acctcreateevent">
                                	...
                                	<div class="reg_wid_form_left" style="width:668px;">
                                    	...
                                    	<div class="addevent_2btn_main" style="padding-top:0px;"><input type="button" onClick="javascript:send_twitter_invite();" name="send_invitation" id="send_invitation" class="addevent_3btn" value="" /></div>
                                    </div>
