    ...
    <body>
                        	...
                        	<div class="tab_box_bg_inner_regconf" style="min-height:470px; padding-top:10px;">
                                ...
                                <div class="cplus_acctcreateevent">
                                	...
                                	<div class="reg_wid_form_left" style="width:668px;">
                                    	<div class="form_login_title" style="width:668px;">Remind Your Twitter Followers</div>
										<a href="https://twitter.com/intent/tweet?original_referer=<?=$SITE_URL;?>create_twitter_invitation.php?event_id=<?=$event_id;?>&amp;source=tweetbutton&amp;text=Join me at the event I created on CelebratePlus&amp;url=<?=$SITE_URL;?>event_detail.php?eve_id=<?=$event_id;?>" class="twitter-share-button" data-count="none">Tweet</a>
      ...
      <script type="text/javascript">
        ...
        function debugEvent(intent_event) {
          ...
          alert('Your reminder has successfully been shared with your followers on Twitter');

        }
		twttr.events.bind('tweet',    debugEvent);

      </script>
                                  <?php //  	<div class="addevent_2btn_main" style="padding-top:0px;"><input type="button" onClick="javascript:send_twitter_invite();" name="send_invitation" id="send_invitation" class="addevent_3btn" value="" /></div> ?>
                                    </div>
